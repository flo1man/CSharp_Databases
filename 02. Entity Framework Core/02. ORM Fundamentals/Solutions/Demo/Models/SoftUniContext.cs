...
namespace Demo.Models
{
    public partial class SoftUniContext : DbContext
    {
        ...
        public virtual DbSet<VUserWithHighestSalary> VUserWithHighestSalaries { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<DeletedEmployee>(entity =>
            {
                entity.HasKey(e => e.EmployeeId)
                    .HasName("PK__Deleted___7AD04F116B7AB04A");
                ...
                entity.HasOne(d => d.Department)
                    ...
                    .HasConstraintName("FK__Deleted_E__Depar__628FA481");
            });
            ...
            modelBuilder.Entity<VUserWithHighestSalary>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_UserWithHighestSalary");
