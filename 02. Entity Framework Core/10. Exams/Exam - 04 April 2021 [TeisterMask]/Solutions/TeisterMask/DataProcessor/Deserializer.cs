namespace TeisterMask.DataProcessor
{
    ...
    public class Deserializer
    {
        ...
        public static string ImportProjects(TeisterMaskContext context, string xmlString)
        {
            ...
            var importProjectDtos = XmlConverter.Deserializer<ImportProjectsModel>(xmlString, "Projects");
        ...
        {
            var importEmployeeDtos = JsonConvert.DeserializeObject<List<ImportEmployeeModel>>(jsonString);
            var sb = new StringBuilder();
